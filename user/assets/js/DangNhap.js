...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const taikhoanSpan = document.querySelector(
    ".header_top_right_taikhoan_span"
  );
  const menusaudangnhap = document.querySelector(
    ".header_top_right_taikhoan_name ul.menu_dangnhap"
  );
  ...
  if (userData && taikhoanSpan && menusaudangnhap) {
    ...
    if (user.quyenhang === "quanly") {
      menuHTML += `<li><a href="/admin"><i class="fa-solid fa-user"></i> Quản lí cửa hàng</a></li>`;
    }
