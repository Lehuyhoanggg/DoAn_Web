document.querySelector(".main").innerHTML = ` <div class="home">
            <section class="home_banner">
                <img src="user/assets/image/banner/banner2.png" alt="">
            </section>
            <section class="home_sanpham">
                <h2 class="home_sanpham_tieude">
                    <span>Khám phá sản phẩm của chúng tôi</span>
                </h2>
            ...
            <section class="home_spnoibat">
                <div class="home_spnoibat_top">
                    <h2> Sản phẩm nổi bật</h2>
                </div>

                <div class="home_spnoibat_bottom">

                    <img class="home_spnoibat_bottom_img" src="user/assets/image/banner/vuottroi.png" alt="">
                    <ul class="home_spnoibat_bottom_list">
                        <li class="home_spnoibat_bottom_list_item">
                            <img src="user/assets/image/sanpham/sp1.png" alt="">
                            <div class="sanpham_bottom_ctn">

                                <p class="sanpham_name">Samsung Galaxy S25 FE 5G 8GB/256GB</p>
                                <div class="sanpham_thongso">
                                    <span class="sanpham_thongso_item">Full HD+</span>
                                    <span class="sanpham_thongso_item">6.7'</span>
                                </div>

                                <span class="sanpham_prime">9999999999</span>
                                <span class="sanpham_giamgia">13772777</span>

                                <p class="sanpham_daban">Đã bán 7k</p>

                                <button class="sanpham_muangay">
                                    <svg width="25" height="25" viewBox="0 0 100 100"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect width="100" height="100" fill="transparent" />
                                        <g fill="none" stroke="white" stroke-width="7" stroke-linecap="round"
            ...
            <section class="home_tintuc">
                <h2>Tin tức</h2>
                <ul class="home_tintuc_list">
                    <li class="home_tintuc_list_item">
                        <img src="user/assets/image/tintuc/tintuc1.jpg" alt="">
                        <p class="home_tintuc_list_item-tieude">
                            So sánh các loại iPad: Pro, Air, Mini, Gen - Chọn iPad nào phù hợp?
                        </p>
                    </li>
                    <li class="home_tintuc_list_item">
                        <img src="user/assets/image/tintuc/tintuc1.jpg" alt="">
